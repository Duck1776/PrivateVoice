...
class AudioReceiver:
    ...
    def start(self):
        ...
        try:
            ...
            while self.running:
                encrypted_data = input_stream.read(self.chunk)
                decrypted_data = self.cipher.decrypt(encrypted_data)  # Decrypting audio data
                output_stream.write(decrypted_data)  # Play decrypted audio through speaker
